class User < AppllicationRecord 
    ...
    valdiates :username, presence: true, uniqueness: true
    ...
    def self.find_by_credentials(username, password)            #finding the user in the database - only used when we login
